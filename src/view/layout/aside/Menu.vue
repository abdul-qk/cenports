  ...
  <ul class="menu-nav">
    ...
    >
      ...
      >
        <a :href="href" class="menu-link" @click="navigate">
          ...
          <span class="menu-text">Fullfilment Master</span>
        </a>
      </li>
    </router-link>
    ...
    >
      ...
      >
        <a :href="href" class="menu-link" @click="navigate">
          <i class="menu-icon flaticon2-expand"></i>
          <span class="menu-text">Vendor Channels</span>
        </a>
      </li>
    </router-link>
    ...
    >
      ...
      >
        <a :href="href" class="menu-link" @click="navigate">
          <i class="menu-icon flaticon2-expand"></i>
          <span class="menu-text">Sales Channels</span>
        </a>
      </li>
    </router-link>
          ...
          >
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Inventory Allocation</span>
              </a>
            </li>
          </router-link>
        </ul>
    ...
    >
      ...
      >
        <a :href="href" class="menu-link" @click="navigate">
          <i class="menu-icon flaticon2-expand"></i>
          <span class="menu-text">Onboard</span>
        </a>
      </li>
    </router-link>
    ...
    >
      ...
      >
        <a :href="href" class="menu-link" @click="navigate">
          <i class="menu-icon flaticon2-expand"></i>
          <span class="menu-text">Retailer Invoices</span>
        </a>
      </li>
    </router-link>
    ...
    >
      ...
      >
        <a :href="href" class="menu-link" @click="navigate">
          <i class="menu-icon flaticon2-expand"></i>
          <span class="menu-text">My Settings</span>
        </a>
      </li>
    </router-link>
